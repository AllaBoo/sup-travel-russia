...
module.exports = {
  entry: {
    ...
    denis: './src/scripts/denis.js',
    gala: './src/scripts/gala.js',
    viva: './src/scripts/viva.js',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      inject: false,
      template: './src/denis.html',
      filename: './denis.html',
      chunks: ['denis'],
    }),
    new HtmlWebpackPlugin({
      inject: false,
      template: './src/gala.html',
      filename: './gala.html',
      chunks: ['gala'],
    }),
    new HtmlWebpackPlugin({
      inject: false,
      template: './src/viva.html',
      filename: './viva.html',
      chunks: ['viva'],
    }),
    new HtmlWebpackPlugin({
      inject: false,
      template: './src/anton.html',
      filename: './anton.html',
      chunks: ['anton'],
    }),
    new HtmlWebpackPlugin({
